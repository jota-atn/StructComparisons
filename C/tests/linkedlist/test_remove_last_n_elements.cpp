...
auto test_remove_last_n_elements(LinkedList& linked_list, int n) {
...
void test_dataset_remove_last_n_elements(LinkedList& linked_list, int num_execucoes) {
    ...
    string saida = "../out/linkedlist/remove_last_n_elements.txt";
    ...
    for (int valor : values) {
        ...
        for (int i = 0; i < num_execucoes; i++) {
            tempo_total += test_remove_last_n_elements(linked_list, num_elementos);
        }

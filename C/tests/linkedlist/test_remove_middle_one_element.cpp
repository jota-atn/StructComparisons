...
auto test_remove_middle_one_element(LinkedList& linked_list) {
...
void test_dataset_remove_middle_one_element(LinkedList& linked_list, int num_execucoes) {
    ...
    string saida = "../out/linkedlist/remove_mid_one_element.txt";
    ...
    for (int valor : values) {
        ...
        for (int i = 0; i < num_execucoes; ++i) {
            tempo_total += test_remove_middle_one_element(linked_list);
        }
        ...
        cout << "Tempo medio de remocao no meio de 1 elemento para um Data Set de tamanho " << to_string(valor)

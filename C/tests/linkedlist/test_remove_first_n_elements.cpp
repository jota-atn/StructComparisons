...
auto test_remove_first_n_elements(LinkedList& linked_list, int n) {
...
void test_dataset_remove_first_n_elements(LinkedList& linked_list, int num_execucoes) {
    
    vector<int> values = {10000, 100000, 250000, 500000, 600000, 750000, 1000000, 1700000, 2500000, 3700000, 5000000};
        
    string saida = "../out/linkedlist/remove_first_n_elements.txt";
    ...
    for (int valor : values) {
        ...
        for (int i = 0; i < num_execucoes; ++i) {
            tempo_total += test_remove_first_n_elements(linked_list, num_elementos);
        }
        ...
        cout << "Tempo medio de remocao no inicio de " << num_elementos

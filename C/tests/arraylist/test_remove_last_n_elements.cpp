...
auto test_remove_last_n_elements(ArrayList& array_list, int n) {
...
void test_dataset_remove_last_n_elements(ArrayList& array_list, int num_execucoes) {
    ...
    string saida = "C:/Users/jamqu/Projects/StructComparisons/C/out/remove_last_n_elements.txt";
    ...
    for (int valor : values) {
        ...
        for (int i = 0; i < num_execucoes; ++i) {
            tempo_total += test_remove_last_n_elements(array_list, num_elementos);
        }

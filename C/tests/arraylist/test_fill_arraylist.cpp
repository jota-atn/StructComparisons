...
auto test_fill_arraylist(ArrayList& array_list, int n) {

    auto inicio = high_resolution_clock::now();
    
    array_list.fill_array(to_string(n));
...
void test_dataset_fill_arraylist(ArrayList& array_list, int num_execucoes) {
    ...
    string saida = "../out/arraylist/fill_arraylist.txt";
    ...
    for (int valor : values) {
        ...
        for (int i = 0; i < num_execucoes; ++i) {
            tempo_total += test_fill_arraylist(array_list, num_elementos);
        }
        ...
        cout << "Tempo medio de preenchimento de um ArrayList para um Data Set de tamanho " << to_string(valor)

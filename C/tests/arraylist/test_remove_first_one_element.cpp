...
auto test_remove_first_one_element(ArrayList& array_list) {
...
void test_dataset_remove_first_one_element(ArrayList& array_list, int num_execucoes) {
    ...
    string saida = "C:/Users/jamqu/Projects/StructComparisons/C/out/remove_first_one_elements.txt";
    ...
    for (int valor : values) {
        ...
        for (int i = 0; i < num_execucoes; ++i) {
            tempo_total += test_remove_first_one_element(array_list);
        }

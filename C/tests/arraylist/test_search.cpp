...
auto test_search_element(ArrayList& array_list, int element) {
    auto inicio = high_resolution_clock::now();
    
    array_list.contains(element);
...
void test_dataset_search_element(ArrayList& array_list, int num_execucoes) {
    ...
    string saida = "C:/Users/jamqu/Projects/StructComparisons/C/out/search_element.txt";
    ...
    for (int valor : values) {
        ...
        for (int i = 0; i < num_execucoes; ++i) {
            tempo_total += test_search_element(array_list, elemento_alvo);
        }

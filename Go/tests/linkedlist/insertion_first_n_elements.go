...
func testInsertFirst(lista *linkedlist.LinkedList, n int) int64 {
    inicio := time.Now()
...
func testDatasetInsertionFirstNElements(lista *linkedlist.LinkedList, numExecucoes int) {
    ...
    saida := "./out/linkedlist/insertion_first_n_elements.txt"

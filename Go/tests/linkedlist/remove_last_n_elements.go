...
func testRemoveLastNElements(lista *linkedlist.LinkedList, n int) int64 {
	inicio := time.Now()
...
func testDatasetRemoveLastNElements(lista *linkedlist.LinkedList) {
	...
	saida := "./out/linkedlist/remove_last_n_elements.txt"

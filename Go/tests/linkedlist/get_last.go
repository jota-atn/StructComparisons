...
func testGetLast(lista *linkedlist.LinkedList) int64 {
    inicio := time.Now()
...
func testDatasetGetLast(lista *linkedlist.LinkedList) {
    valores := []int{10, 100000, 250000, 500000, 600000, 750000, 1000000, 1700000, 2500000, 3700000, 5000000, 6000000, 7500000, 9000000, 10000000}
    
    saida := "./out/linkedlist/get_last.txt"

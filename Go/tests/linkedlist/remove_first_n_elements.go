...
func testRemoveFirstNElements(lista *linkedlist.LinkedList, n int) int64 {
	inicio := time.Now()
...
func testDatasetRemoveFirstNElements(lista *linkedlist.LinkedList) {
	...
	saida := "./out/linkedlist/remove_first_n_elements.txt"

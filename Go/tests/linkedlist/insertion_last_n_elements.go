...
func testAdd(lista *linkedlist.LinkedList, n int) int64 {
	inicio := time.Now()
...
func testDatasetInsertionLastNElements(lista *linkedlist.LinkedList) {
	...
	saida := "./out/linkedlist/insertion_last_n_elements.txt"

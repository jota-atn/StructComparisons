...
func testAddOneElement(lista *arraylist.ArrayList) int64 {
...
func testDatasetInsertionLastOneElement(lista *arraylist.ArrayList) {
	...
	saida := "./out/arraylist/insertion_last_one_element.txt"

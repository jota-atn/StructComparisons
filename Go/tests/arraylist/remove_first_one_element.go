...
func testRemoveFirstOneElement(lista *arraylist.ArrayList) int64 {
	inicio := time.Now()
...
func testDatasetRemoveFirstOneElement(lista *arraylist.ArrayList) {
	...
	saida := "./out/arraylist/remove_first_one_element.txt"

...
func testRemoveLastOneElement(lista *arraylist.ArrayList) int64 {
	inicio := time.Now()
...
func testDatasetRemoveLastOneElement(lista *arraylist.ArrayList) {
	...
	saida := "./out/arraylist/remove_last_one_element.txt"

...
// testFindMin mede o tempo para encontrar o valor mínimo na árvore AVL
func testFindMin(arvore *avltree.AVLTree) int64 {
	inicio := time.Now()
...
func testDatasetFindMin(arvore *avltree.AVLTree) {
	...
	for _, valor := range valores {
		...
		fmt.Printf("Tempo medio de busca do valor mínimo em uma Árvore AVL de tamanho %d após %d execuções: %.4f nanossegundos\n",
